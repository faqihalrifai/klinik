...
<head>
    ...
    <title>SIMKLINIK - <?php echo $__env->yieldContent('title', 'Admin Dashboard'); ?></title>
    <!-- Bootstrap 5 CSS -->
    ...
    <div id="wrapper">
        ...
        <nav id="sidebar">
            ...
            <ul class="list-unstyled components">
                ...
                <li class="<?php echo e(request()->routeIs('pasien.*') ? 'active' : ''); ?>">
                    <a href="<?php echo e(route('pasien.index')); ?>"><i class="fas fa-users"></i> Data Pasien</a>
                </li>
                <li class="<?php echo e(request()->routeIs('dokter.*') ? 'active' : ''); ?>">
                    <a href="<?php echo e(route('dokter.index')); ?>"><i class="fas fa-user-md"></i> Data Dokter</a>
                </li>
                <li class="<?php echo e(request()->routeIs('jadwal.*') ? 'active' : ''); ?>">
                    <a href="<?php echo e(route('jadwal.index')); ?>"><i class="fas fa-calendar-alt"></i> Jadwal Konsultasi</a>
                </li>
                <li class="<?php echo e(request()->routeIs('laporan.*') ? 'active' : ''); ?>">
                    <a href="<?php echo e(route('laporan.index')); ?>"><i class="fas fa-file-medical-alt"></i> Laporan Medis</a>
                </li>
            </ul>
        </nav>
        ...
        <div id="page-content-wrapper">
            ...
            <nav class="top-navbar">
                <div>
                    ...
                    <h4 class="mb-0 ms-2 d-inline-block text-secondary" style="font-weight: 600;"><?php echo $__env->yieldContent('title', 'Dashboard'); ?></h4>
                </div>
                <div>
                    <div class="dropdown">
...
<?php /**PATH C:\xampp\htdocs\simklinik\resources\views/layouts/app.blade.php ENDPATH**/ ?>
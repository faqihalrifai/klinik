...
unset($__errorArgs, $__bag); ?>" id="telp" name="telp" value="<?php echo e(old('telp')); ?>">
...
unset($__errorArgs, $__bag); ?>" type="radio" name="jenis_kelamin" id="jk_l" value="L" <?php echo e(old('jenis_kelamin') == 'L' ? 'checked' : ''); ?> required>
...
unset($__errorArgs, $__bag); ?>" type="radio" name="jenis_kelamin" id="jk_p" value="P" <?php echo e(old('jenis_kelamin') == 'P' ? 'checked' : ''); ?> required>
...
unset($__errorArgs, $__bag); ?>" id="riwayat_penyakit" name="riwayat_penyakit" rows="3"><?php echo e(old('riwayat_penyakit')); ?></textarea>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\simklinik\resources\views/pasien/create.blade.php ENDPATH**/ ?>
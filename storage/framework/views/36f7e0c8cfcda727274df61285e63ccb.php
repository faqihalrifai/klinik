<?php $__env->startSection('title', 'Edit Jadwal Konsultasi'); ?>
...
unset($__errorArgs, $__bag); ?>" id="pasien_id" name="pasien_id" required>
                            ...
                            <?php $__currentLoopData = $pasiens; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pasien): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($pasien->id); ?>" <?php echo e(old('pasien_id', $jadwal->pasien_id) == $pasien->id ? 'selected' : ''); ?>>
                                    <?php echo e($pasien->nama); ?> (<?php echo e($pasien->telp ?? '-'); ?>)
                                </option>
...
unset($__errorArgs, $__bag); ?>" id="dokter_id" name="dokter_id" required>
                            ...
                            <?php $__currentLoopData = $dokters; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dokter): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($dokter->id); ?>" <?php echo e(old('dokter_id', $jadwal->dokter_id) == $dokter->id ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>" id="tanggal" name="tanggal" value="<?php echo e(old('tanggal', $jadwal->tanggal)); ?>" required>
...
unset($__errorArgs, $__bag); ?>" id="jam" name="jam" value="<?php echo e(old('jam', \Carbon\Carbon::parse($jadwal->jam)->format('H:i'))); ?>" required>
                        <?php $__errorArgs = ['jam'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>" id="status" name="status" required>
                    <option value="menunggu" <?php echo e(old('status', $jadwal->status) == 'menunggu' ? 'selected' : ''); ?>>Menunggu</option>
                    <option value="proses" <?php echo e(old('status', $jadwal->status) == 'proses' ? 'selected' : ''); ?>>Proses</option>
...
unset($__errorArgs, $__bag); ?>" id="keluhan" name="keluhan" rows="3"><?php echo e(old('keluhan', $jadwal->keluhan)); ?></textarea>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\simklinik\resources\views/jadwal/edit.blade.php ENDPATH**/ ?>
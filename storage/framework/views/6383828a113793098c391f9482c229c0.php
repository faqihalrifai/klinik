...
<head>
    <meta charset="UTF-8">
    <title>Laporan Medis - <?php echo e($laporan->pasien->nama); ?></title>
    <style>
...
<body>
    ...
    <table class="info-table">
        <tr>
            <th>No. Laporan</th>
            <td>: #LM-<?php echo e(str_pad($laporan->id, 4, '0', STR_PAD_LEFT)); ?></td>
            <th>Tanggal Periksa</th>
            <td>: <?php echo e(\Carbon\Carbon::parse($laporan->tanggal)->format('d F Y')); ?></td>
        </tr>
        <tr>
            <th>Nama Pasien</th>
            <td>: <strong><?php echo e($laporan->pasien->nama); ?></strong></td>
            <th>Dokter Pemeriksa</th>
            <td>: <?php echo e($laporan->dokter->nama); ?></td>
        </tr>
        <tr>
            <th>Jenis Kelamin</th>
            <td>: <?php echo e($laporan->pasien->jenis_kelamin == 'L' ? 'Laki-laki' : 'Perempuan'); ?></td>
            <th>Spesialis</th>
            <td>: <?php echo e($laporan->dokter->spesialis); ?></td>
        </tr>
    </table>
    ...
    <div class="content-section">
        ...
        <div class="content-box">
            <?php echo nl2br(e($laporan->diagnosa)); ?>
    ...
    <div class="content-section">
        ...
        <div class="content-box">
            <?php echo nl2br(e($laporan->tindakan ?? '-')); ?>
    ...
    <div class="content-section">
        <h3>Resep Obat</h3>
        <div class="content-box">
            <?php echo nl2br(e($laporan->resep ?? '-')); ?>
    ...
    <div class="footer">
        ...
        <div class="signature">
            dr. <?php echo e($laporan->dokter->nama); ?>
...
<?php /**PATH C:\xampp\htdocs\simklinik\resources\views/laporan/pdf.blade.php ENDPATH**/ ?>